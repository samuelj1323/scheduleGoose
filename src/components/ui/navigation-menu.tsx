...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        "group/navigation-menu flex  flex-1 items-left justify-left",
        className
      )}
      {...props}
    >
...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        "group flex flex-1 list-none items-center w-full justify-center",
        className
      )}
      {...props}
    />
